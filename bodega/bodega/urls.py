...
urlpatterns = [
    ...
    url(r'^categoria/', include ('apps.categoria.urls', namespace="categoria")),
    url(r'^salida/', include ('apps.salida.urls', namespace="salida")),
    url(r'^ingreso/', include ('apps.ingreso.urls', namespace="ingreso")),
    url(r'^stock/', include ('apps.stock.urls', namespace="stock")),
